    ...
    <body class="bg-gray-100 font-family-karla flex">
        ...
        <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
            <div class="p-6">
                ...
                <button data-toggle="modal" data-target="#upload-modal"
            ...
            <nav class="text-white text-base font-semibold pt-3">
                ...
                <a href="/tokens/manage"
                    class="flex items-center {{ Request::is('tokens/*') ? 'active-nav-link' : '' }} text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            ...
            <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
                ...
                <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                    <button @click="isOpen = !isOpen"
                        ...
                        <img src="/{{ auth()->user()->profile ?? 'profiles/default.jpg' }}">
                    </button>
            ...
            <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
                ...
                <nav :class="isOpen ? 'flex' : 'hidden'" class="flex flex-col pt-4">
                    ...
                    <a
                        ...
                        <i class="fas fa-arrow-circle-up mr-3"></i> API Documentation
                    </a>
                </nav>
            </header>
            ...
            <div class="modal fade" id="upload-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form class="form" method="post" action="/user/upload" target="_blank"
